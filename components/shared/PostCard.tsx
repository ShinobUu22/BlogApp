...
const PostCard: React.FC<Props> = ({ post }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-xl p-0 lg:p-8 pb-12 mb-8">
      ...
      <span className="leading-normal mr-10 float-right w-fit text-xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-600 bg-clip-text text-transparent">
        {post.categoryId.charAt(0).toUpperCase() + post.categoryId.slice(1)}
      </span>
      ...
      <div className="text-center flex flex-col">
        <span
          className="transition duration-500 transform hover:-translate-y-1 inline-block bg-gradient-to-r from-purple-500 to-blue-600 text-lg font-medium rounded-full text-white py-3 px-8 cursor-pointer mx-10"
          onClick={handleClick}
        >
          Continue Reading
        </span>
